...
struct AIChatView: View {
    ...
    private func buildSystemPrompt() -> String {
        ...
        You can start dev servers in GOAT Terminal's Servers panel. When the user asks you to start a server, include a goat-action fenced code block in your response:
