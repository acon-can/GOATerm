...
final class ShellIntegrationService {
    ...
    private func setupZDOTDIR(originalZDOTDIR: String?) -> String? {
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("goat-\(ProcessInfo.processInfo.processIdentifier)")
        ...
        do {
            ...
            let zshenvContent = """
            # GOAT Shell Integration Bootstrap
    ...
    private func findIntegrationScript() -> String? {
        ...
        if let bundlePath = Bundle.main.path(forResource: "goat-integration", ofType: "zsh") {
            return bundlePath
        }
        ...
        // SPM puts resources in GOAT_GOAT.bundle
        let spmBundlePath = executableURL
            .appendingPathComponent("GOAT_GOAT.bundle")
            .appendingPathComponent("goat-integration.zsh")
        if FileManager.default.fileExists(atPath: spmBundlePath.path) {
            return spmBundlePath.path
        }

        // Check alongside the executable
        let adjacentPath = executableURL.appendingPathComponent("goat-integration.zsh")
